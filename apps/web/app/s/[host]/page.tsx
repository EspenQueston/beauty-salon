...
import { fetchReviews, fetchSalon } from "@/lib/api";
        ...
        {featured.length > 0 ? (
          ...
          <Reveal as="section" className="pt-4">
            <EmptyNote icon="scissors" title="Le catalogue arrive">
              Ce salon prépare ses prestations. En attendant, écrivez-lui — il
              répond aux messages.
            </EmptyNote>
          </Reveal>
        )}
      ...
      */}
      ...
      >
        <div className="mx-auto max-w-5xl px-4">
          <Reveal>
            <SectionTitle eyebrow="En trois étapes" title="Comment ça se passe" />
          </Reveal>
      ...
      <div className="mx-auto max-w-5xl px-4">
              ...
              action={
                salon.gallery.length > showcase.length ? (
                  <MoreLink href="/realisations">
                    Les {salon.gallery.length} réalisations
                  </MoreLink>
                ) : undefined
              }
            />
        ...
        {reviews.results.length > 0 && (
          <Reveal as="section" className="pt-20">
            <SectionTitle
              eyebrow="Ce qu'en disent les clientes"
              title="Avis vérifiés"
            />
            <ReviewList
        ...
        <Reveal as="section" className="pt-20">
          <SectionTitle
            ...
            action={<MoreLink href="/infos">Tout le détail</MoreLink>}
          />
          ...
          */}
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            <h3 className="flex items-center gap-2 font-semibold text-[var(--site-ink)]">
              <SalonIcon name="clock" className="size-4.5 text-[var(--salon-ink)]" />
              Horaires
            </h3>
            <StatutOuverture
              salon={salon}
        ...
        {salon.address && (
          <Card className="lift">
            <h3 className="mb-2 flex items-center gap-2 font-semibold text-[var(--site-ink)]">
              <SalonIcon name="pin" className="size-4.5 text-[var(--salon-ink)]" />
              Adresse
            </h3>
        ...
        {contacts.length > 0 && (
          <Card className="lift">
            <h3 className="mb-3 flex items-center gap-2 font-semibold text-[var(--site-ink)]">
              <SalonIcon name="phone" className="size-4.5 text-[var(--salon-ink)]" />
              Nous joindre
            </h3>
  ...
  return (
    <div className="salon-gradient relative overflow-hidden rounded-3xl px-6 py-14 text-center text-white sm:px-12">
      ...
      <p className="relative mx-auto mt-3 max-w-md text-white/85">
        Choisissez votre créneau en ligne, à toute heure. Confirmation
        immédiate, annulation gratuite jusqu&apos;à{" "}
